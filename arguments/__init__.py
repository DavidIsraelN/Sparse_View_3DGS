...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self._source_path = ""              
        self._model_path = ""
        self._images = "colmap/images"
        self._resolution = -1
        self._white_background = False
        self.data_device = "cuda:0"
        self.eval = False
        self.preload_img = True
        self.multi_view_num_filter = 20
        self.multi_view_num_ncc = 8       
        self.multi_view_max_angle = 30    
        self.multi_view_min_dis = 0.01  
        self.multi_view_max_dis = 1.5
        self._use_mask = 1
        self.create_mask = False
        self.aligned_depth = True
        self.comput_pmap = True
        self.save_color_pmaps = False
        self.skybox = False
        self.skybox_points = 100000
        self.mask_type = "sky"    # ["sky", "object"]
        self.scene_opac = False
        self.depth_converter = False
        self.contrib_densify = True
        self.patch_size = 3
        self.sample_num = 102400
        self.prior_depth = True
        self.prior_normal = True
        self.smooth = True
        self.warp = True
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.densify_grad_threshold = 0.0012 
        self.depth_threshold = 1                

        self.multi_view_weight_from_iter = 7000
        self.geom_prior_until_iter = 15_000
        self.opacity_cull_threshold = 0.005
        self.max_all_points = 5_000_000
